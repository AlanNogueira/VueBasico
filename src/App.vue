...
import DatBinding from './components/DatBinding.vue';
...
const cachorros = [
  { nome: "Cachorro1", idade: 1 },
  { nome: "Cachorro2", idade: 2 },
  { nome: "Cachorro3", idade: 3 }
]
</script>
...
<template>
  ...
  <RenderizacaoListas nome="Alan" :cachorros="cachorros" />
  <RenderizacaoCondicional nome="Alan" :qtd-cachorros="0" />
  <PropriedadesAssistidas />
  <PropriedadesComputadas />
  <EscutaEvento />
  <ComProps item="Nome do segundo item" :preco="100.50" />
  <DatBinding />
